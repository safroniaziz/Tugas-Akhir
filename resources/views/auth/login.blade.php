...
<html>
	<head>
		<meta charset="utf-8">
        <title>Pola Sebaran Gempa Bumi Mentawai | Login</title>
		...
		<div id="particles-js">
            <div class="loginBox">
                ...
                @if ($message = Session::get('error'))
                    ...
                    @else
                    <h6 style="font-size: 20px; margin-bottom:10px;">Form Login Administrator</h6>
                    <p style="text-align:center; margin-bottom:20px;">Aplikasi Pemetaan Pola Sebaran Gempa Bumi Mentawai</p>
                @endif
                <form method="post" action="{{ route('login') }}">
                    ...
                    <div class="form-group">
                        ...
                        @error('email')
                            <div class="invalid-feedback form-alert text-danger">
                                {{ $message }}
                            </div>
                        @enderror
                    </div>
